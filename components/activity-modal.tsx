...
import { ClockCircle, Planet } from "@solar-icons/react";
      ...
      <DialogContent className="border-border bg-card sm:max-w-md">
        <DialogHeader className="pb-2">
          ...
          <p className="text-sm text-muted-foreground">
            {activity
              ...
              : "Create a new activity for your planner"}
          </p>
        </DialogHeader>
        ...
        <div className="space-y-5 py-4">
          ...
          <div className="space-y-2.5">
            ...
            >
              <Planet weight="LineDuotone" className="w-5 h-5 text-primary" />
              English Name
            </Label>
            <Input
              id="name"
          ...
          <div className="space-y-2.5">
            <Label
              htmlFor="nameKh"
              className="text-sm font-medium flex items-center gap-2 font-khmer"
            >
              <Planet weight="LineDuotone" className="w-5 h-5 text-primary" />
              ឈ្មោះខ្មែរ
            </Label>
          ...
          <div className="space-y-2.5">
            ...
            >
              <ClockCircle weight="LineDuotone" className="w-5 h-5 text-primary" />
              {t.duration}
            </Label>
